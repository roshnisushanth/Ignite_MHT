<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Plan.ascx.cs" Inherits="Hick.Encounters.UserControls.Plan" %>
...
<body>
    <form id="form_plan" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px;">
        <div>
            ...
            <div class="patsearch_border">
                ...
                <div style="display: -webkit-box; display: inline-flex; margin-top: 40px;">
                    <div style="padding-top: 9px;"><span style="margin-left: 40px; font-weight: bold;">Enter Plan Notes</span></div>
                    <div style="margin-left: 20px;">
                        <asp:TextBox ID="txtNotes" ClientIDMode="Static" TextMode="multiline" Columns="60" Rows="5" runat="server" />
                    </div>
                </div>
                <div style="margin-left: 19%; margin-top: 20px;">
...
<script>
    ...
    $('#save_item').click(function () {
        var data, date = $('#dob').val(),
            ...
            aid = $('#asId').val(),
            objid = $('#objid').val(),
            method = (objid && objid != 0) ? 'EditPlan' : 'AddPlan',
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.d == "error") {
                    ...
                    $('#objid').val(result.d);
                    showSucess({ text: 'Plan updated successfully.' });
                }
                else {
                    showSucess({ text: 'Plan updated successfully.' });
                }
