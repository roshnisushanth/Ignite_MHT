       ...
       public string currentuser;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                currentuser = patientid.ToString();
                currentuserId.Value= patientid.ToString();
                Session["PatientID"] = patientid.ToString();
        ...
        public void BindConditions(long patientid)
        {
            ...
            try
            {
                ...
                if (patientid != 0)
                {
                    ...
                    //var uri = ConfigurationManager.AppSettings["serviceURL"] + "/conditionsbypatientid"; //conditions
                    //var postData = "{\"Pin\":\"" + PinValue + "\",\"PatientID\":\"" + patientid + "\"}";
                ...
                //objColl.Add(new Conditons {Condition="XYZ",DateOfOnset="17-08-2015",ICDCode="290",PatientID=12345 });
                //objColl.Add(new Conditons { Condition = "XYZd", DateOfOnset = "17-08-2015", ICDCode = "291", PatientID = 12343 });
                grdconditions.DataSource = objColl;
        ...
        protected void save_vitals_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                //var postData = "{\"PatientID\":\"" + Session["PatientID"] + "\",\"Pin\":\"" + PIN + "\",\"Height\":\"" + txt_Height.Text + "\",\"HeightUnits\":\"" + ddlHeightUnits.SelectedItem.ToString() + "\",
                //    \"Weight\":\"" + txt_weight.Text + "\",\"WeightUnits\":\"" + ddlWeightUnits.SelectedItem.ToString() + "\",
                //    \"Temperature\":\"" + txt_temp.Text + "\",\"TemperatureUnit\":\"" + ddlTemperatureUnit.SelectedItem.ToString() + "\",\"Pulse\":\"" + txt_pulse.Text + "\",
                //    \"Respiration\":\"" + txtRespiration.Text + "\",\"BloodPressure\":\"" + txtBP.Text + "/" + txtBP2.Text + "\"}";
