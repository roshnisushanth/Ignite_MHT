...
{
    public partial class UCAddEditDemographics : System.Web.UI.UserControl
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //var postData = "{\"PatientID\":\"" + Session["PatientID"] + "\",\"Pin\":\"" + Pin + "\",\"LastName\":\"" + txt_lastname.Text + "\",\"FirstName\":\"" + txt_firstname.Text + "\",
                //    \"DOB\":\"" + txt_dob.Text + "\",\"Last4SSN\":\"" + txt_SSN.Text + "\",\"HICN\":\"" + txt_hicn.Text + "\",\"Address1\":\"" + txt_address1.Text + "\",
                //    \"Address2\":\"" + txt_address2.Text + "\",\"City\":\"" + txt_city.Text + "\",\"State\":\"" + ddlState.SelectedValue + "\",\"Zip\":\"" + txt_zipcode.Text + "\",\"PhoneNumber\":\"" + txt_phonenumber.Text + "\"}";
                //var res = Utility.PostRequestForSave(uri, postData);
                if (res == "1")
                {
                    lbl_msg.Text = "Demographics updated successfully";
                    BindPatientdetails(Convert.ToInt32(Session["PatientID"]));
                }
                else
                {
                    lbl_msg.Text = "Demographics not updated successfully";
                    BindPatientdetails(Convert.ToInt32(Session["PatientID"]));
                }
