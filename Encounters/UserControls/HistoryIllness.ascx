<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HistoryIllness.ascx.cs" Inherits="Hick.Encounters.UserControls.HistoryIllness" %>
<!DOCTYPE>
        ...
        <div>
            ...
            <div class="patsearch_border">
                ...
                <div style="display: -webkit-box; display: inline-flex; margin-top: 40px;">
                    <div style="padding-top: 9px;"><span style="margin-left: 40px; font-weight: bold;">Enter HPI Notes</span></div>
...
<script type="text/javascript">
    ...
    $('#save_item').click(function () {
        var data, date = $('#dob').val(),
            ...
            aid = $('#asId').val(),
            objid = $('#objid').val(),
            method = (objid && objid != 0) ? 'EditHPI' : 'AddHPI',
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                else if (method == 'AddHPI') {
                    $('#objid').val(result.d);
                    showSucess({ text: 'History of Illness updated successfully.' });
                }
                else {
                    showSucess({ text: 'History of Illness updated successfully.' });
                }
